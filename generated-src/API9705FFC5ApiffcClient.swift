...
public class API9705FFC5ApiffcClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "API9705FFC5ApiffcClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:API9705FFC5ApiffcClient = {
        ...
        return API9705FFC5ApiffcClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = API9705FFC5ApiffcClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `API9705FFC5ApiffcClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> API9705FFC5ApiffcClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         API9705FFC5ApiffcClient.registerClient(withConfiguration: configuration, forKey: "USWest2API9705FFC5ApiffcClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = API9705FFC5ApiffcClient.client(forKey: "USWest2API9705FFC5ApiffcClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(API9705FFC5ApiffcClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> API9705FFC5ApiffcClient {
		objc_sync_enter(self)
		if let client: API9705FFC5ApiffcClient = _serviceClients.object(forKey: key) as? API9705FFC5ApiffcClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			API9705FFC5ApiffcClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! API9705FFC5ApiffcClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://v672drj0wj.execute-api.ap-northeast-1.amazonaws.com/dev"
    ...
    /*
     ...
     return type: 
     */
    public func usersProxyOptions(proxy: String) -> AWSTask<AnyObject> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("OPTIONS", urlString: "/Users/{proxy+}", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: nil)
	}
